...
export function startAuction(property) {
  return { type: 'AUCTION_PROPERTY', property }
}
...
export function saveState(saveType, note, blame = []) {
  return { type: 'SAVE_STATE', saveType, note, blame }
}
