Property = (function () {
  ...
  function Property(props) {
    ...
    // Properly set the owner
    this.owner = Player.get(this.owner);
  ...
  Property.prototype = {
    ...
    improve: function() {
      ...
      if (!this.isMonopoly) {
        throw('Needs to be a monopoly');
      }

      // Already fully improved
      if (this.buildings === 0) {
        throw('Already fully improved');
      }

      // Must build evenly
      if (!_.equalProps(this.all, 'buildings')) {
        throw('Must build evenly');
      }
    ...
    unimprove: function() {
      ...
      if (this.buildings === 0) {
        throw('Already fully unimproved');
      }
    ...
    mortgage: function() {
      ...
      if (this.isMortgaged) {
        throw('Property is already mortgaged');
      }

      // Property is improved
      if (this.isImproved) {
        throw('Property is improved');
      }
