Player = (function () {
  ...
  function Player(props) {
    ...
    // Get any properties
    this.properties = Property.belongsTo(this);
  ...
  Player.prototype = {
    ...
    transfer: function(player, what) {
      ...
      case 'assets':
        ...
        for (var asset in this.assets) {
          player.assets[asset] = (player.assets[assets] || 0) + this.assets[asset];
      ...
      default:
        ...
        // Assume we're transferring a property
          ...
          property = Property.get(what);

          // Property has improvements
          if (property.isImproved) {
            throw('Cannot transfer improved property');
          }

          property.transfer(player);
        }
    ...
    imporove: function(property) {
      ...
      if (this !== property.owner) {
        throw('You are not the property owner');
      }
    ...
    unmortgage: function(property) {
      ...
      if (property.cost >= this.balance) {
        throw('You do not have enough currency');
      }
